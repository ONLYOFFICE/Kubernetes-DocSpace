...
- [Deploy ONLYOFFICE DocSpace](#deploy-onlyoffice-docspace)
  * [1. Install ONLYOFFICE DocSpace](#1-install-onlyoffice-docspace)
  * [2. Uninstall ONLYOFFICE DocSpace](#2-uninstall-onlyoffice-docspace)
  * [3. Upgrade ONLYOFFICE DocSpace](#3-upgrade-onlyoffice-docspace)
...
### 2. Uninstall ONLYOFFICE DocSpace
...
| `podAnnotations`                                       | Map of annotations to add to the ONLYOFFICE DocSpace pods                                                                   | `rollme: "{{ randAlphaNum 5 \| quote }}"` |
...
| `images.tag`                                           | Global image tag for all ONLYOFFICE DocSpace applications. Does not apply to the Document Server, Elasticsearch and Proxy Frontend | `2.0.3`                       |
| `jwt.enabled`                                          | Specifies the enabling the JSON Web Token validation by the ONLYOFFICE DocSpace                                             | `true`                        |
| `jwt.secret`                                           | Defines the secret key to validate the JSON Web Token in the request to the ONLYOFFICE DocSpace                             | `jwt_secret`                  |
