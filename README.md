...
| `containerSecurityContext.enabled`                     | Enable security context for containers in DocSpace application pods. Individual values for `docs` and `elasticsearch`       | `false`                       |
