...
- [Configuration and installation details](#configuration-and-installation-details)
  ...
  * [3. Scale ONLYOFFICE DocSpace (optional)](#3-scale-onlyoffice-docs-optional)
...
*This step is optional. You can skip step [3](#3-scale-onlyoffice-docs-optional) entirely if you want to use default deployment settings.*
