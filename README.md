...
| `connections.qdrant.host`                              | The name of the Qdrant service used for vector storage service                                                              | `qdrant`                      |
| `connections.qdrant.port`                              | The HTTP port on which the Qdrant service accepts connections                                                               | `6333`                        |
...
### ONLYOFFICE DocSpace Langflow Backend additional parameters
