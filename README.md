...
|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| `global.installationType`                              | Defines solution type for DocSpace and Docs                                                                                 | `COMMUNITY`                   |
| `connections.envExtension`                             | Defines whether an environment will be used                                                                                 | `""`                          |
| `connections.installationType`                         | The parameter is evaluated as a template and is equal to `global.installationType`                                          | {{ .Values.global.installationType }} |
