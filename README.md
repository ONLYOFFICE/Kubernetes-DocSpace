...
| `connections.appKnownProxies`                          | Defines the addresses of known proxies to accept forwarded headers from for DocSpace services. These are the proxies that you are using in front of DocSpace services. Use to specify exact IP address matches | `""` |
| `connections.appKnownNetworks`                         | Defines the address ranges of known networks to accept forwarded headers from for DocSpace services. Use to specify networks | `""`                         |
