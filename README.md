...
| `podSecurityContext.enabled`                           | Enable security context for the pods. If set to true, `podSecurityContext` is enabled for all resources describing the podTemplate. Individual values for `docs`, `elasticsearch` and `Jobs` | `false`                |
...
| `containerSecurityContext.enabled`                     | Enable security context for containers in DocSpace application pods. Individual values for `docs`, `elasticsearch` and `Jobs` | `false`                       |
