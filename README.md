...
| `connections.appKnownProxies`                          | Defines the addresses of known proxies to accept forwarded headers from for DocSpace services. Use to specify exact IP address matches | `""`               |
