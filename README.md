...
| Parameter                                                 | Description                                                                                                     | Default                                   |
|-----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| `Application.enabled`                                     | Enables Application installation. Not used in `identity.identityAuthorization` and `identity.identityApi`. | `Deployment`                                                                                | `true`                                    |
...
| `identity.identityMigration.job.image.repository`   | Job by identityMigration container image repository repository                                                                                                                                             | `onlyoffice/docspace-migration-runner`          |
